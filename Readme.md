...
# Parsing + Configuration Script – S400-PLC4 - Rev. A

This **Parsing + Configuration** script is designed for the **S400-PLC4** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – S400-PLC4 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **S400-PLC4** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
