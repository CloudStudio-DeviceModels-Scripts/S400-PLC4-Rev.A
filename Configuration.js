...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  // endpoints.addEndpoint("2", "CO2 sensor", endpointType.ppmConcentrationSensor, ppmConcentrationSensorSubType.carbonDioxide);
   ...
   var e = endpoints.addEndpoint("ALM_H_PIT01", "Alarma Alta Presion de Cober", endpointType.appliance);
  var e = endpoints.addEndpoint("ALM_Blowers", "Alarma Paro de Blowers", endpointType.appliance);
  var e = endpoints.addEndpoint("40-PIT-01", "Presion de Cover", endpointType.genericSensor);
